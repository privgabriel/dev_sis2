interface Game {
  ...
  ratingScore: number;
  image: string;
  trailer: string; // Novo campo para armazenar o trailer do YouTube
}
...
const games: Game[] = [
  {
    ...
    trailer: "https://www.youtube.com/watch?v=c0i88t0Kacs", // Trailer correto para The Witcher 3
  },
  {
    id: 2,
    ...
    trailer: "https://www.youtube.com/watch?v=eaW0tYpxyp0", // Trailer correto para Red Dead Redemption 2
  },
  {
    id: 3,
    ...
    trailer: "https://www.youtube.com/watch?v=zw47_q9wbBE", // Trailer correto para The Legend of Zelda: Breath of the Wild
  },
  {
    id: 4,
    name: "Fortnite",
    ...
    trailer: "https://www.youtube.com/watch?v=2gUtfBmw86Y", // Trailer correto para Fortnite
  },
  {
    id: 5,
    name: "Cyberpunk 2077",
    ...
    trailer: "https://www.youtube.com/watch?v=FknHjl7eQ6o", // Trailer correto para Cyberpunk 2077
  },
];
